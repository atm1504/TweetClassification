...
def main():
    ...
    src_dir = "features"
    time_dirs = [d for d in os.listdir(src_dir) if d.startswith("2020")]
    ...
    for time_dir in time_dirs:
        ...
        print("Load hashtag features...", features_dir)
        print(num_hashtags)
        ...
        for num_words in num_words_list:
            ...
            clusters_dir = "clusters_kmeans/k_{3:d}/{0}/hashtag_{1:d}_word_{2:d}".format(
                time_dir, num_hashtags, num_words, num_clusters)
            ...
            for idx, cluster in enumerate(hashtag_clusters):
                with open(os.path.join(clusters_dir, "hashtag_cluster_{0:d}.txt".format(idx)), "w") as output:
                    for hashtag_id in cluster:
                        ...
                        output.write(str(hashtag.encode("utf-8")))
                        output.write(u"\n")
